...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        // 每天 19 点发 1000
        $schedule->command('mail:ad 1000 --everytime=20')->dailyAt('19:00')->sendOutputTo($this->storageFile());
        // 每天 20 点发剩下的
        $schedule->command('mail:ad 1400 --everytime=20')->dailyAt('20:00')->sendOutputTo($this->storageFile());
